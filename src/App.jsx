...
function App() {
  const handleQuoteSubmit = (event) => {
    ...
    const whatsappMessage = `Hello Triple S Safety Solutions,
...
Enquiry: ${message || 'No additional details provided'}`
    ...
    const whatsappNumber = '27670119233'
  ...
  return (
    <>
      ...
      <footer className="footer">
        ...
        <div className="footer-bottom">Copyright 2026 Triple S Safety Solutions. All rights reserved.</div>
      </footer>
    </>
  )
}
